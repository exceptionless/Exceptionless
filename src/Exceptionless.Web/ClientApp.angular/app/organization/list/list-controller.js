    ...
    angular
        ...
        .controller(
            ...
            function (
                ...
                function add() {
                    return dialogs
                        .create("app/organization/list/add-organization-dialog.tpl.html", "AddOrganizationDialog as vm")
                        .result.then(createOrganization)
                        .catch(function (e) {});
                }
                ...
                function get(options, useCache) {
                    ...
                    return organizationService
                        .getAll(vm.currentOptions, useCache)
                        .then(onSuccess)
                        .finally(function () {
                            vm.loading = false;
                        });
                ...
                function leave(organization, user) {
                    return dialogService
                        ...
                        .then(function () {
                            ...
                            return organizationService
                                .removeUser(organization.id, user.email_address)
