            ...
            function (
                ...
                function add(isRetrying) {
                    ...
                    if (canCreateOrganization()) {
                        return createOrganization(vm.organization_name)
                            .then(createProject)
                            .then(resetCanAdd, resetCanAdd);
                    }
                ...
                function getOrganizations() {
                    function onSuccess(response) {
                        ...
                        vm.organizations.push({
                            id: vm._newOrganizationId,
                            name: translateService.T("<New Organization>"),
                        });

                        var currentOrganizationId = vm.currentOrganization.id
