            ...
            function (
                ...
                function getProjectTypes() {
                    return [
                        ...
                        {
                            key: "Exceptionless",
                            name: translateService.T("Console and Service applications"),
                            platform: ".NET",
                        },
                        { key: "Exceptionless.AspNetCore", name: "ASP.NET Core", platform: ".NET" },
                        {
                            key: "Exceptionless.Mvc",
                            name: "ASP.NET MVC",
                            config: "web.config",
                            platform: ".NET",
                        },
                        {
                            key: "Exceptionless.WebApi",
                            name: "ASP.NET Web API",
                            config: "web.config",
                            platform: ".NET",
                        },
                        {
                            key: "Exceptionless.Web",
                            name: "ASP.NET Web Forms",
                            config: "web.config",
                            platform: ".NET",
                        },
                        {
                            key: "Exceptionless.Windows",
                            name: "Windows Forms",
                            config: "app.config",
                            platform: ".NET",
                        },
                        {
                            key: "Exceptionless.Wpf",
                            name: "Windows Presentation Foundation (WPF)",
                            config: "app.config",
                            platform: ".NET",
                        },
                        {
                            key: "Exceptionless.Nancy",
                            name: "Nancy",
                            config: "app.config",
                            platform: ".NET",
                        },
                        {
                            key: "Exceptionless.JavaScript",
                            name: translateService.T("Browser applications"),
                            platform: "JavaScript",
                        },
