...
(function () {
    ...
    angular
        ...
        .controller(
            "session.Events",
            function ($ExceptionlessClient, eventService, $filter, filterService, translateService) {
                var vm = this;
                function get() {
                    ...
                    function onSuccess(response) {
                        ...
                        vm.chart.options.series[0].data = dateAggregation.map(function (item) {
                            return {
                                ...
                                y: getAggregationValue(item, "cardinality_user", 0),
                                data: item,
                            };
                        });
                    ...
                    return eventService
                        .count(
                            "avg:value cardinality:user date:(date" +
                                (offset ? "^" + offset : "") +
                                " cardinality:user)",
                            false,
                            optionsCallback
