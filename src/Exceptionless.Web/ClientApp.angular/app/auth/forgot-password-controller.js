(function () {
    ...
    angular
        ...
        .controller(
            "auth.ForgotPassword",
            function ($ExceptionlessClient, $state, translateService, authService, notificationService) {
                var vm = this;
                function resetPassword(isValid) {
                    ...
                    function onSuccess() {
                        $ExceptionlessClient
                            .createFeatureUsage(vm._source + ".resetPassword.success")
                            .setUserIdentity(vm.email)
                            .submit();
                    ...
                    function onFailure(response) {
                        $ExceptionlessClient
                            .createFeatureUsage(vm._source + ".resetPassword.error")
                            .setUserIdentity(vm.email)
                    ...
                    $ExceptionlessClient
                        .createFeatureUsage(vm._source + ".resetPassword")
                        .setUserIdentity(vm.email)
                        .submit();
