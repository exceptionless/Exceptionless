            ...
            function (
                ...
                function getEmailNotificationSettings() {
                    ...
                    return projectService
                        .getNotificationSettings(vm.currentProject.id, vm.user.id)
                ...
                function getProjects() {
                    function onSuccess(response) {
                        ...
                        vm.currentProject = vm.projects.filter(function (p) {
                ...
                function saveEmailAddress(isRetrying) {
                    ...
                    return userService
                        .updateEmailAddress(vm.user.id, vm.user.email_address)
                        .then(onSuccess, onFailure)
                        .then(resetCanSaveEmailAddress, resetCanSaveEmailAddress);
                }
                ...
                function saveEmailNotificationSettings() {
                    ...
                    return projectService
                        .setNotificationSettings(vm.currentProject.id, vm.user.id, vm.emailNotificationSettings)
                        .catch(onFailure);
                }
                ...
                function saveEnableEmailNotification() {
                    ...
                    return userService
                        .update(vm.user.id, { email_notifications_enabled: vm.user.email_notifications_enabled })
                        .catch(onFailure);
                }
                ...
                function showChangePlanDialog() {
                    return billingService
                        .changePlan(vm.currentProject ? vm.currentProject.organization_id : null)
                        .catch(function (e) {});
                }
