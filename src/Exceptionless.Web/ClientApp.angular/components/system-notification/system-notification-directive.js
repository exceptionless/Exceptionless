        ...
        function () {
            return {
                ...
                controller: [
                    ...
                    function ($http, $scope, $window, BASE_URL, SYSTEM_NOTIFICATION_MESSAGE) {
                        var svm = this;
                        ...
                        function getSystemNotificationKey(notification) {
                            ...
                            return JSON.stringify([
                                getSystemNotificationDateKey(notification.date),
                                notification.level || "Info",
                                normalizeSystemNotificationTarget(notification.target),
                                notification.message || SYSTEM_NOTIFICATION_MESSAGE || "",
                            ]);
                        }
                        ...
                        function dismissSystemNotification() {
                            ...
                            try {
                                $window.localStorage.setItem(
                                    dismissedSystemNotificationStorageKey,
                                    svm.systemNotificationKey
                                );
                            } catch (e) {
                        ...
                        function showFallbackSystemNotification() {
                            ...
                            svm.systemNotificationKey = SYSTEM_NOTIFICATION_MESSAGE
                                ? JSON.stringify([null, "Info", "Both", SYSTEM_NOTIFICATION_MESSAGE])
                                : null;
                        }

                        function refreshSystemNotification() {
                            return $http
                                .get(BASE_URL + "/api/v2/notifications/system")
