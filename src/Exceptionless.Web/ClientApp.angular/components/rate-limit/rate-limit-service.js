(function () {
    ...
    angular.module("exceptionless.rate-limit").factory("rateLimitService", function ($rootScope) {
        var _rateLimit = -1;
        ...
        function updateFromResponseHeader(response) {
            ...
            var limitRemaining = parseInt(response.headers("X-RateLimit-Remaining"), 10);
