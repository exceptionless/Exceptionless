(function () {
    ...
    angular.module("exceptionless.intercom").directive("intercom", [
        function () {
            return {
                ...
                controller: function (
                    ...
                    function getCurrentOrganization() {
                        function getOrganizationFromProjectFilter() {
                            ...
                            if (project) {
                                return vm.organizations.filter(function (o) {
                                    return o.id === project.organization_id;
                                })[0];
                            }
                        ...
                        if (filterService.getOrganizationId()) {
                            currentOrganization = vm.organizations.filter(function (o) {
                                return o.id === filterService.getOrganizationId();
                            })[0];
                        } else if (filterService.getProjectId()) {
                            currentOrganization = getOrganizationFromProjectFilter();
                        }

                        return currentOrganization || vm.organizations[0];
                    }
                    ...
                    function getIntercomData() {
                        ...
                        if (versionParts.length === 3) data.app_build = parseInt(versionParts[2], 10);
