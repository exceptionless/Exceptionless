    ...
    angular
            ...
            function (
                ...
                var routes = [
                    ...
                    { key: "events", title: "Events", controller: "app.Events" },
                    {
                        ...
                        templateUrl: "app/events.tpl.html",
                        redirectToKey: "events",
                    },
                    {
                        key: "dashboard",
                        title: "Events",
                ...
                routes.forEach(function (route) {
                        ...
                        angular.extend(
                            {},
                            {
                                ...
                                onEnter: [
                                    ...
                                    "$timeout",
                                    "filterService",
                                    function ($state, $stateParams, $timeout, filterService) {
                                ...
                                onEnter: [
                                    ...
                                    function ($state, $stateParams, $timeout, filterService) {
                                        ...
                                        if (route.redirectToKey) {
                                            return $timeout(function () {
                                                $state.transitionTo(
                                                    "app.project-type-" + route.redirectToKey,
                                                    $stateParams
                                                );
                                            });
                                        }
                                ...
                                onEnter: [
                                    ...
                                    function ($state, $stateParams, $timeout, filterService) {
                                        if (route.redirectToKey) {
                                            return $timeout(function () {
                                                $state.transitionTo(
                                                    "app.organization-" + route.redirectToKey,
                                                    $stateParams
                                                );
                                            });
                                        }
                    ...
                    $stateProvider.state(
                        "app.organization-type-" + route.key,
                        angular.extend(
                            {},
                            {
                                ...
                                onEnter: [
                                    ...
                                    function ($state, $stateParams, $timeout, filterService) {
                                        ...
                                        if (route.redirectToKey) {
                                            return $timeout(function () {
                                                $state.transitionTo(
                                                    "app.organization-type-" + route.redirectToKey,
                                                    $stateParams
                                                );
                                            });
                                        }
                ...
                var onEnter = [
                    ...
                    "$state",
                    "$timeout",
                    function (authService, $location, $state, $timeout) {
                ...
                $stateProvider.state("otherwise", {
                    ...
                    onEnter: [
                        ...
                        function ($stateParams) {
                            $ExceptionlessClient
                                .createNotFound($stateParams.path)
        ...
        .run(
            function (
                ...
                if (
                    ((typeof USE_SSL === "boolean" && USE_SSL) || USE_SSL === "true") &&
                ...
                $rootScope.$on("$stateChangeStart", function (event, toState, toParams) {
                    if (!toState || !toState.data || !toState.data.requireAuthentication) return;
