...
public static class OAuthApplicationEndpoints
{
    public static IEndpointRouteBuilder MapOAuthApplicationEndpoints(this IEndpointRouteBuilder endpoints)
    {
        ...
        endpoints.MapGet("api/v2/admin/oauth-applications", async (IMediator mediator, IMediatorResultMapper<Microsoft.AspNetCore.Http.IResult> resultMapper)
        ...
        endpoints.MapPost("api/v2/admin/oauth-applications", async (HttpContext httpContext, IMediator mediator, IMediatorResultMapper<Microsoft.AspNetCore.Http.IResult> resultMapper, [FromBody] NewOAuthApplication model)
        ...
        group.MapPut("{id:objectid}", async (string id, HttpContext httpContext, IMediator mediator, IMediatorResultMapper<Microsoft.AspNetCore.Http.IResult> resultMapper, [FromBody] UpdateOAuthApplication model)
        ...
        group.MapDelete("{id:objectid}", async (string id, IMediator mediator, IMediatorResultMapper<Microsoft.AspNetCore.Http.IResult> resultMapper)
