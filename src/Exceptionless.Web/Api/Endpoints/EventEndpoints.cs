...
internal static class EventEndpointHelpers
{
    ...
    [
        new("environment", "query", Description: "The deployment environment (for example, production or staging). Names are trimmed, lowercased, and limited to 64 characters; missing or invalid names remain unspecified."),
