            ...
            return {
                ...
                controller: function (
                    ...
                    function get(options, useCache) {
                        ...
                        return vm.settings
                            .get(vm.currentOptions, useCache)
                    ...
                    function canRefresh(data) {
                        ...
                        if (data.type === "Organization") {
                            ...
                            return (
                                vm.projects.filter(function (e) {
                                    return data.id === e.organization_id;
                                }).length > 0
                            );
                        }
                        ...
                        if (data.type === "Project") {
                            ...
                            return (
                                vm.projects.filter(function (e) {
                                    ...
                                    data.organization_id = e.organization_id;
