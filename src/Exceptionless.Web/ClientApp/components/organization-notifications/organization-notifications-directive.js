(function () {
    ...
    angular
        .module("exceptionless.organization-notifications", [
            "angular-intercom",
            "app.config",
                ...
                controller: function (
                    ...
                    function get() {
                        return getOrganizations()
                            .then(getProjects)
                            .then(getFilterUsesPremiumFeatures)
                            .then(getOrganizationNotifications);
                    }
                    ...
                    function getCurrentOrganizationId() {
                        function getOrganizationFromProjectFilter() {
                            ...
                            var project = vm.projects.filter(function (o) {
                                return o.id === filterService.getProjectId();
                            })[0];
                        ...
                        return (
                            ...
                            filterService.getOrganizationId() ||
                            getOrganizationFromProjectFilter()
                        );
                    }
                    ...
                    function getCurrentProjects() {
                        ...
                        if (currentOrganizationId) {
                            return vm.projects.filter(function (p) {
                                return p.organization_id === currentOrganizationId;
                            });
                        }

                        if (filterService.getProjectId()) {
                            return vm.projects.filter(function (p) {
                                return p.id === filterService.getProjectId();
                            });
                        }
                    ...
                    function getOrganizationNotifications() {
                        ...
                        angular.forEach(vm.organizations, function (organization) {
                            ...
                            var canShowConfigurationAlert =
                                currentProjects.filter(function (p) {
                                    return p.is_configured === false;
                                }).length === currentProjects.length;
                            ...
                            var tryingToSearchWithoutPremiumFeatures =
                                vm.filterUsesPremiumFeatures && !organization.has_premium_features;
                            var upgradeRequiredForPremiumFeatures =
                                $scope.requiresPremium && !organization.has_premium_features;
                            if (
                                (tryingToSearchWithoutPremiumFeatures || upgradeRequiredForPremiumFeatures) &&
                                !canShowConfigurationAlert
                            ) {
                    ...
                    function getOrganizations() {
                        function getSelectedOrganization() {
                            ...
                            if (
                                !organizationId ||
                                vm.organizations.filter(function (o) {
                    ...
                    function hasOrganizationsWithoutPremiumFeatures() {
                        return (
                            vm.organizationsWithoutPremiumFeatures && vm.organizationsWithoutPremiumFeatures.length > 0
                        );
                    }
                    ...
                    function hasSuspendedForAbuseOrOverageOrNotActiveOrganizations() {
                        return (
                            vm.suspendedForAbuseOrOverageOrNotActiveOrganizations &&
                            vm.suspendedForAbuseOrOverageOrNotActiveOrganizations.length > 0
                        );
                    }
                    ...
                    this.$onInit = function $onInit() {
                        ...
                        vm.hasSuspendedForAbuseOrOverageOrNotActiveOrganizations =
