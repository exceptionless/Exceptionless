            ...
            function (
                ...
                var markOpenAction = {
                    ...
                    run: function (ids) {
                        ...
                        function onFailure() {
                            $ExceptionlessClient
                                .createFeatureUsage(source + ".mark-open.error")
                        ...
                        $ExceptionlessClient
                            .createFeatureUsage(source + ".mark-open")
                            .setProperty("count", ids.length)
                            .submit();
                ...
                var deleteAction = {
                    ...
                    run: function (ids) {
                        $ExceptionlessClient
                            .createFeatureUsage(source + ".delete")
                            .setProperty("count", ids.length)
                            .submit();
                        return dialogService
                            ...
                            .then(function () {
                                ...
                                function onFailure() {
                                    $ExceptionlessClient
                                        .createFeatureUsage(source + ".delete.error")
                                        .setProperty("count", ids.length)
                                        .submit();
                                    notificationService.error(
                ...
                var markFixedAction = {
                    ...
                    run: function (ids) {
                        $ExceptionlessClient
                            .createFeatureUsage(source + ".mark-fixed")
                            .setProperty("count", ids.length)
                            .submit();
                        return stackDialogService
                            ...
                            .then(function (version) {
                                ...
                                function onFailure() {
                                    $ExceptionlessClient
                                        .createFeatureUsage(source + ".mark-fixed.error")
                                        .setProperty("count", ids.length)
                                        .submit();
                                    notificationService.error(
                ...
                var markIgnoredAction = {
                    ...
                    run: function (ids) {
                        ...
                        function onFailure() {
                            $ExceptionlessClient
                                .createFeatureUsage(source + ".mark-ignored.error")
                                .setProperty("count", ids.length)
                                .submit();
                            notificationService.error(
                        ...
                        $ExceptionlessClient
                            .createFeatureUsage(source + ".mark-ignored")
                            .setProperty("count", ids.length)
                            .submit();
                        return executeAction(
                            ids,
                ...
                var markDiscardedAction = {
                    ...
                    run: function (ids) {
                        ...
                        function onFailure() {
                            $ExceptionlessClient
                                .createFeatureUsage(source + ".mark-discarded.error")
                                .setProperty("count", ids.length)
                                .submit();
                            notificationService.error(
                        ...
                        $ExceptionlessClient
                            .createFeatureUsage(source + ".mark-discarded")
                            .setProperty("count", ids.length)
                            .submit();
                        return executeAction(
                            ids,
