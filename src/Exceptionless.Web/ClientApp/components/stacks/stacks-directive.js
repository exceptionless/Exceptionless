(function () {
    ...
    angular.module("exceptionless.stacks").directive("stacks", function () {
        return {
            ...
            controller: function (
                ...
                function get(options) {
                    ...
                    function onFailure(response) {
                        ...
                        $ExceptionlessClient
                            .createLog(vm._source + ".get", "Error while loading stacks", "Error")
                ...
                function updateSelection() {
                    if (vm.stacks && vm.stacks.length === 0) return;
