/* eslint-disable */
/* https://raw.githubusercontent.com/bendrucker/angularjs-stripe/master/release/angular-stripe.js */
    ...
    return (function e(t, n, r) {
    ...
    })(
        {
                ...
                function (_dereq_, module, exports) {
                    (function (global) {
                        ...
                        module.exports = angular
                            .module("assert-q-constructor", [])
                            .factory("assertQConstructor", main).name;
                ...
                function (_dereq_, module, exports) {
                    (function (global) {
                        ...
                        module.exports = (
                            ...
                            .module("promisify", [])
                            .service("promisify", promisify).name;
                    }).call(
                        this,
                        typeof global !== "undefined"
                            ? global
            ...
            9: [
                ...
                { "assert-ok": 11, "print-value": 27, "simple-format": 29 },
            ],
            10: [
                function (_dereq_, module, exports) {
                    "use strict";
                ...
                function (_dereq_, module, exports) {
                    ...
                    module.exports.get = function (obj, path) {
                        ...
                        for (var i = 0; i < pathArr.length; i++) {
                            var descriptor =
                                Object.getOwnPropertyDescriptor(obj, pathArr[i]) ||
            ...
            27: [
                ...
                { isobject: 20, "json-stringify-safe": 21 },
            ],
            28: [
                function (_dereq_, module, exports) {
                    !(function (glob) {
                ...
                function (_dereq_, module, exports) {
                    ...
                    function toErrback(method, receiver) {
                        return function errback() {
                            ...
                            receiver[method].apply(
                                receiver,
                                args.concat(function onStripe(status, response) {
                                    if (response.error)
            ...
            35: [
                ...
                { "dot-prop": 15, "lazy-async": 22, "load-script-global": 24, "stripe-errback": 30 },
            ],
            36: [
                function (_dereq_, module, exports) {
                    "use strict";
