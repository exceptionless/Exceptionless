(function () {
    ...
    angular.module("exceptionless.summary", ["exceptionless.truncate"]).directive("summary", function () {
        return {
            restrict: "E",
            scope: {
                source: "=",
            ...
            link: function (scope) {
                var level =
                    scope.source && scope.source.data && scope.source.data.Level
                        ? scope.source.data.Level.toLowerCase()
                        : null;
