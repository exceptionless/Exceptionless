            ...
            return {
                ...
                controller: function (
                        ...
                        return dialogService
                            ...
                            .then(function () {
                                ...
                                return organizationService
                                    .removeUser(vm.settings.organizationId, user.email_address)
                    ...
                    function resendNotification(user) {
                        ...
                        return organizationService
                            .addUser(vm.settings.organizationId, user.email_address)
                            .catch(onFailure);
                    }

                    function updateAdminRole(user) {
                        $ExceptionlessClient
                            .createFeatureUsage(vm._source + ".updateAdminRole")
                            .setProperty("user", user)
                            .submit();
                        var message = !userService.hasAdminRole(user)
                        ...
                        return dialogService
                            ...
                            .then(function () {
                                function onSuccess() {
                                    $ExceptionlessClient
                                        .createFeatureUsage(vm._source + ".updateAdminRole.success")
                                        .setProperty("user", user)
                                        .submit();
                                }
                                ...
                                function onFailure() {
                                    $ExceptionlessClient
                                        .createFeatureUsage(vm._source + ".updateAdminRole.error")
                                        .setProperty("user", user)
                                        .submit();
                                    notificationService.error(
                                        translateService.T(
