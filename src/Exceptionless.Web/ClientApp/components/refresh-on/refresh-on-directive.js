(function () {
    ...
    angular
        .module("exceptionless.refresh", ["debounce"])
            ...
            return {
                ...
                link: function (scope, element, attrs) {
                    ...
                    if (attrs.refreshDebounce) {
                        action = debounce(action, parseInt(attrs.refreshDebounce || 1000, 10), true);
                    } else if (attrs.refreshThrottle) {
                        action = _.throttle(action, parseInt(attrs.refreshThrottle || 1000, 10));
                    }
