...
Keep shared email-client resets in `EmailLayout.svelte`. Template-specific compatibility styles belong to the template that renders them; footer styles belong to their footer component. The colors in `theme.ts` preserve the established production email palette.
