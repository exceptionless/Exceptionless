        ...
        <ActionsFooter>
            {#snippet actions()}
                <li class="mt-[5px] ml-[5px]">
                    <Link href="{'{{BaseUrl}}'}/organization/{'{{OrganizationId}}'}/manage" class="text-primary no-underline">View usage</Link>
                </li>
                <li class="mt-[5px] ml-[5px]">
                    <Link href="{'{{BaseUrl}}'}/account/manage?tab=notifications" class="text-primary no-underline">Change your notification settings</Link>
                </li>
            {/snippet}
        </ActionsFooter>
    {/snippet}
