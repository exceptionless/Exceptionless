...
<EmailLayout styles={socialFooterStyles}>
    {#snippet content()}
        <Section data-email-content class="px-4 py-2">
            <Heading as="h1" class="text-dark mt-0 mb-[5px] text-[34px] leading-[1.3] font-normal">You've been invited to become Exceptionless!</Heading>
            <Text class="text-dark text-[20px] leading-[1.6]">{@html '{{Subject}}'}</Text>
