...
import { UpdateRateNotificationRuleSchema } from '$generated/schemas';
import { describe, expect, it } from 'vitest';

import { getRateNotificationRuleFormData, RateNotificationRuleSchema } from './schemas';
...
describe('generated rate notification update schema', () => {
    it('accepts nullable signal and subject values', () => {
        const result = UpdateRateNotificationRuleSchema.safeParse({
            signal: null,
            subject: null
        });
