...
<!-- CUSTOM: KEEP KBD KEY-STYLE COMMAND SHORTCUT RENDERING; THIS CHANGE WAS INTRODUCED IN THE 2680d3ddb UI POLISH COMMIT AND SHOULD NOT BE OVERWRITTEN BY SHADCN UPDATES. -->
<kbd
	bind:this={ref}
