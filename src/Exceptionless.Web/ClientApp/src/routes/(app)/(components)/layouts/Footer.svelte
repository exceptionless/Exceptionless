	...
	<ul class="mb-6 flex flex-wrap items-center md:mb-0">
		<li>
			...
			<A
				...
				variant="navigation"
				target="_blank"
				class="mr-4 md:mr-6">Exceptionless</A
			>
		</li>
		<li>
			<A href="https://exceptionless.com/news/" variant="navigation" class="mr-4 md:mr-6"
				>News</A
			>
		</li>
		<li>
			<A href="https://exceptionless.com/terms/" variant="navigation" class="mr-4 md:mr-6"
				>Terms of Use</A
			>
		</li>
		<li>
			<A href="https://exceptionless.com/privacy/" variant="navigation" class="mr-4 md:mr-6"
				>Privacy Policy</A
			>
		</li>
		<li>
		...
		<li>
			<A href="https://github.com/exceptionless/Exceptionless/releases" variant="navigation"
				>9.0-TODO</A
			>
		</li>
	</ul>
