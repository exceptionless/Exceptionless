...
<div class="space-y-6">
    ...
    <Avatar.Root title="TODO" class="h-24 w-24">
    ...
    <form on:submit|preventDefault={onSave} class="space-y-2">
        ...
        <TextInput name="full_name" label="Full Name" bind:value={data.full_name} autocomplete="name" required {problem}></TextInput>
        <EmailInput name="email_address" label="Email Address" bind:value={data.email_address} autocomplete="email" required {problem}></EmailInput>
        <div class="pt-2">
            <Button type="submit">
                {#if $loading}
