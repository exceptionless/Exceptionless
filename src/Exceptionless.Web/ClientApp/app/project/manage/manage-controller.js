            ...
            function (
                ...
                function getOrganization() {
                    function onSuccess(response) {
                        function getRemainingEventLimit(organization) {
                            ...
                            var bonusEvents = moment.utc().isBefore(moment.utc(organization.bonus_expiration))
                                ? organization.bonus_events_per_month
                                : 0;
                        ...
                        var defaultUsage = [
                            {
                                ...
                                discarded: 0,
                                blocked: 0,
                                limit: vm.organization.max_events_per_month,
                                too_big: 0,
                            },
                        ];
                        vm.organization.usage = (vm.organization.usage || defaultUsage).filter(function (usage) {
                            return vm.project.usage.some(function (u) {
                                return moment(u.date).isSame(usage.date);
                            });
                        });
                ...
                function getSlackNotificationSettings() {
                    ...
                    return projectService
                        .getIntegrationNotificationSettings(vm._projectId, "slack")
                        .then(onSuccess, onFailure);
                }
                ...
                function saveCommonMethods() {
                    ...
                    if (vm.common_methods) {
                        return projectService
                            .setData(vm._projectId, "CommonMethods", vm.common_methods)
                            .catch(onFailure);
                    }
                ...
                function saveDataExclusion() {
                    ...
                    if (vm.data_exclusions) {
                        return projectService
                            .setConfig(vm._projectId, "@@DataExclusions", vm.data_exclusions)
                            .catch(onFailure);
                    }
                ...
                function saveDeleteBotDataEnabled() {
                    ...
                    return projectService
                        .update(vm._projectId, { delete_bot_data_enabled: vm.project.delete_bot_data_enabled })
                        .catch(onFailure);
                }
                ...
                function saveIncludePrivateInformation() {
                    ...
                    if (vm.exclude_private_information === true) {
                        return projectService
                            .setConfig(vm._projectId, "@@IncludePrivateInformation", false)
                            .catch(onFailure);
                    }
                ...
                function saveUserAgents() {
                    ...
                    if (vm.user_agents) {
                        return projectService
                            .setConfig(vm._projectId, "@@UserAgentBotPatterns", vm.user_agents)
                            .catch(onFailure);
                    }
                ...
                function saveUserNamespaces() {
                    ...
                    if (vm.user_namespaces) {
                        return projectService
                            .setData(vm._projectId, "UserNamespaces", vm.user_namespaces)
                            .catch(onFailure);
                    }
                ...
                function saveSlackNotificationSettings() {
                    ...
                    return projectService
                        .setIntegrationNotificationSettings(vm._projectId, "slack", vm.slackNotificationSettings)
                        .catch(onFailure);
                }
