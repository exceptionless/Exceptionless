    ...
    angular
        ...
        .controller(
            ...
            function (
                ...
                function addUser() {
                    return dialogs
                        .create("app/organization/manage/add-user-dialog.tpl.html", "AddUserDialog as vm")
                        .result.then(createUser);
                }
                    ...
                    return dialogService
                        ...
                        .then(function () {
                            ...
                            return organizationService
                                .removeUser(vm._organizationId, currentUser.email_address)
