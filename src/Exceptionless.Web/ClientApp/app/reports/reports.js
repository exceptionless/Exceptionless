(function () {
    ...
    angular
        ...
        .config(function ($stateProvider) {
            ...
            var resetEventStatusOnExit = [
                "filterService",
                function (filterService) {
                    filterService.setStatus(null, true);
                },
            ];
            var routeDefaults = {
            ...
            $stateProvider.state(
                "app.reports.organization-status",
                angular.extend(
                    {},
                    {
                        ...
                        onEnter: [
                            "$stateParams",
                            "filterService",
                            function ($stateParams, filterService) {
