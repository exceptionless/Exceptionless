(function () {
    ...
    angular.module("app.session").directive("sessions", function (linkService) {
        return {
            ...
            controller: function (
                ...
                function open(id, event) {
                    ...
                    $ExceptionlessClient
                        .createFeatureUsage(vm.source + ".open")
                        .setProperty("id", id)
                ...
                function nextPage() {
                    $ExceptionlessClient
                        .createFeatureUsage(vm.source + ".nextPage")
                ...
                function previousPage() {
                    $ExceptionlessClient
                        .createFeatureUsage(vm.source + ".previousPage")
