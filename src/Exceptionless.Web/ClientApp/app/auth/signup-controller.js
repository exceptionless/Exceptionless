            ...
            function (
                ...
                function authenticate(provider) {
                    function onSuccess() {
                        ...
                        $ExceptionlessClient
                            .createFeatureUsage(vm._source + ".authenticate")
                            .setProperty("InviteToken", vm.token)
                            .addTags(provider)
                            .submit();
                    ...
                    function onFailure(response) {
                        $ExceptionlessClient
                            .createFeatureUsage(vm._source + ".authenticate.error")
                            .setProperty("InviteToken", vm.token)
                ...
                function signup(isRetrying) {
                    ...
                    function onFailure(response) {
                        $ExceptionlessClient
                            .createFeatureUsage(vm._source + ".signup.error")
                            .setUserIdentity(vm.user.email)
                            .submit();
                        notificationService.error(getMessage(response));
                    }
