(function () {
    ...
    angular
        ...
        .controller(
            "auth.ResetPassword",
            function ($ExceptionlessClient, $state, $stateParams, authService, notificationService, translateService) {
                var vm = this;
                function changePassword(isValid) {
                    ...
                    function onSuccess() {
                        $ExceptionlessClient
                            .createFeatureUsage(vm._source + ".changePassword.success")
                            .setProperty("ResetToken", vm._resetToken)
                            .submit();
                    ...
                    function onFailure(response) {
                        $ExceptionlessClient
                            .createFeatureUsage(vm._source + ".changePassword.error")
                            .setProperty("ResetToken", vm._resetToken)
                    ...
                    $ExceptionlessClient
                        .createFeatureUsage(vm._source + ".changePassword")
                        .setProperty("ResetToken", vm._resetToken)
                        .submit();
                ...
                function cancelResetPassword() {
                    ...
                    function onSuccess() {
                        $ExceptionlessClient
                            .createFeatureUsage(vm._source + ".cancelResetPassword.success")
                            .setProperty("ResetToken", vm._resetToken)
                            .submit();
                    }
                    ...
                    function onFailure(response) {
                        $ExceptionlessClient
                            .createFeatureUsage(vm._source + ".cancelResetPassword.error")
                            .setProperty("ResetToken", vm._resetToken)
                            .setProperty("response", response)
                            .submit();
                    }
                    ...
                    $ExceptionlessClient
                        .createFeatureUsage(vm._source + ".cancelResetPassword")
                        .setProperty("ResetToken", vm._resetToken)
                        .submit();
                    return authService
                        .cancelResetPassword(vm._resetToken)
                        .then(onSuccess, onFailure)
                        .then(redirectToLoginPage, redirectToLoginPage);
                }
