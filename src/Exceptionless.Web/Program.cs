...
public class Program
{
    ...
    public static IHostBuilder CreateHostBuilder(IConfigurationRoot config, string environment)
    {
        ...
        if (options.AppMode is AppMode.Development)
        {
            ...
            Environment.SetEnvironmentVariable("PUBLIC_ENABLE_ACCOUNT_CREATION", options.AuthOptions.EnableAccountCreation.ToString().ToLower());
            ...
            Environment.SetEnvironmentVariable("PUBLIC_STRIPE_PUBLISHABLE_KEY", options.StripeOptions.StripePublishableApiKey);
