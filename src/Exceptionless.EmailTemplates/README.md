...
- a Razor component in `Templates/`;
...
`Exceptionless.Core.Mail.Mailer` creates the models and queues the rendered result. Template registration and dispatch are centralized in `RazorEmailTemplateRenderer`.
