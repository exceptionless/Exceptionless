...
public class UserValidator : AbstractValidator<User>
{
    public UserValidator()
    {
        ...
        RuleFor(u => u.EmailAddress).EmailAddress().WithMessage("Please specify a valid email address.");
        ...
        RuleFor(u => u.VerifyEmailAddressToken).Null().When(u => u.IsEmailAddressVerified).WithMessage("A verify email address token cannot be set if the email address has been verified.");
        ...
        RuleFor(u => u.VerifyEmailAddressTokenExpiration).Empty().When(u => u.IsEmailAddressVerified).WithMessage("A verify email address token expiration cannot be set if the email address has been verified.");
