...
public class OrganizationValidator : AbstractValidator<Organization>
{
    public OrganizationValidator(BillingPlans plans)
    {
        ...
        RuleFor(o => o.SuspendedByUserId).Null().Unless(o => o.IsSuspended).WithMessage("The suspended by user id cannot be set while an organization is not suspended.");
        RuleFor(o => o.SuspensionNotes).NotEmpty().When(o => o.IsSuspended && o.SuspensionCode is SuspensionCode.Other).WithMessage("Please specify a suspension note.");
    }
}
