...
public interface IStackRepository : IRepositoryOwnedByOrganizationAndProject<Stack>
{
    ...
    Task<bool> SetEventCounterAsync(string organizationId, string projectId, string stackId, DateTime firstOccurrenceUtc, DateTime lastOccurrenceUtc, long totalOccurrences, bool sendNotifications = true);
