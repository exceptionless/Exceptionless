...
{
    public string ServerUrl { get; internal set; } = null!;
    ...
    {
        var options = new ElasticsearchOptions { Scope = appOptions.AppScope };
    ...
    {
        var pairs = (connectionString ?? String.Empty).ParseConnectionString(defaultKey: "server");
