...
public static class ElasticsearchBuilderExtensions
{
    ...
    /// <summary>
    /// Adds a Elasticsearch container to the application model. The default image is "docker.elastic.co/elasticsearch/elasticsearch". This version the package defaults to the 9.4.2 tag of the Elasticsearch container image
    /// </summary>
