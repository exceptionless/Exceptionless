...
namespace Exceptionless.Insulation.Configuration.ConnectionStrings {
    public class GraphiteConnectionString : DefaultConnectionString {
        public const string ProviderName = "graphite";

        public GraphiteConnectionString(string connectionString, IDictionary<string, string> settings) : base(connectionString) {
