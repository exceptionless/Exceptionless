...
FROM mcr.microsoft.com/dotnet/sdk:7.0.100-rc.1 AS build
WORKDIR /app
...
FROM mcr.microsoft.com/dotnet/aspnet:7.0.0-rc.1 AS job
WORKDIR /app
...
FROM mcr.microsoft.com/dotnet/aspnet:7.0.0-rc.1 AS api
WORKDIR /app
...
FROM mcr.microsoft.com/dotnet/aspnet:7.0.0-rc.1 AS app
...
FROM exceptionless/elasticsearch:8.4.1 AS exceptionless
