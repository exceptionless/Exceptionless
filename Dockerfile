...
FROM mcr.microsoft.com/dotnet/core/aspnet:5.0 AS job
WORKDIR /app
...
FROM mcr.microsoft.com/dotnet/core/aspnet:5.0 AS api
WORKDIR /app
...
FROM mcr.microsoft.com/dotnet/core/aspnet:5.0 AS app
