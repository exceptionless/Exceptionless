...
FROM mcr.microsoft.com/dotnet/sdk:7.0.100-rc.2 AS build
WORKDIR /app
...
FROM mcr.microsoft.com/dotnet/aspnet:7.0.0-rc.2 AS job
WORKDIR /app
...
FROM mcr.microsoft.com/dotnet/aspnet:7.0.0-rc.2 AS api
WORKDIR /app
...
FROM mcr.microsoft.com/dotnet/aspnet:7.0.0-rc.2 AS app
