...
namespace Exceptionless.Api.Tests.Repositories.InMemory {
    public class RepositoryOwnedByStack<T> : Repository<T>, IRepositoryOwnedByStack<T> where T : class, IOwnedByOrganization, IOwnedByProject, IOwnedByStack, IIdentity, new() {
        public RepositoryOwnedByStack(ICacheClient cacheClient = null, IMessagePublisher messagePublisher = null)
