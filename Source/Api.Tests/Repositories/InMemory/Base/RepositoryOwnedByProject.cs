...
namespace Exceptionless.Api.Tests.Repositories.InMemory {
    public class RepositoryOwnedByProject<T> : Repository<T>, IRepositoryOwnedByProject<T> where T : class, IOwnedByProject, IIdentity, new() {
        public RepositoryOwnedByProject(ICacheClient cacheClient = null, IMessagePublisher messagePublisher = null)
