    ...
    public class Bootstrapper : IPackage {
        public void RegisterServices(Container container) {
            ...
            if (Settings.Current.EnableRedis) {
                ...
                container.RegisterSingleton<IQueue<StatusMessage>>(() => new RedisQueue<StatusMessage>(container.GetInstance<ConnectionMultiplexer>(), container.GetInstance<ISerializer>(), GetQueueName<StatusMessage>(), retries: 0));
