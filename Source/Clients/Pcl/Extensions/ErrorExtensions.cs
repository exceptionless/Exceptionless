...
namespace Exceptionless {
    public static class ErrorExtensions {
        ...
        /// </param>
        /// <returns></returns>
        public static ErrorBuilder ToExceptionless(this Exception exception, bool addDefaultInformation = true, IDictionary<string, object> pluginContextData = null, ExceptionlessClient client = null) {
            if (client == null)
                client = ExceptionlessClient.Current;
            
            var builder = new ErrorBuilder(ExceptionlessClient.ToEvent(client, exception));
