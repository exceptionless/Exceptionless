...
namespace Exceptionless.Queue {
    public class DefaultEventQueue : IEventQueue, IDisposable {
        ...
        public DefaultEventQueue(ISubmissionClient client, IExceptionlessLog log) {
            _client = client;
            _log = log;
        ...
        public Task ProcessAsync() {
            ...
            return _client.SubmitAsync(events, Configuration).ContinueWith(t => {
                ...
                //    t.ContinueWith(ts => _client.GetSettingsAsync(Configuration).ContinueWith(r => {
