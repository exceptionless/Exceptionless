...
namespace Exceptionless.Utility {
    ...
    internal struct ObjectId : IComparable<ObjectId>, IEquatable<ObjectId>, IConvertible {
        ...
        public ObjectId(string value) {
            ...
            Unpack(value.ToByteArray(), out _timestamp, out _machine, out _pid, out _increment);
        }
        ...
        /// </summary>
        public static ObjectId Empty { get { return __emptyInstance; } }
        ...
        /// Gets the machine.
        /// </summary>
        public int Machine { get { return _machine; } }

        /// <summary>
        /// Gets the PID.
        /// </summary>
        public short Pid { get { return _pid; } }
        ...
        /// </summary>
        public DateTime CreationTime { get { return _timestamp.ToDateTime(); } }
        ...
        public static bool TryParse(string s, out ObjectId objectId) {
            ...
            if (s != null && s.Length == 24) {
                try {
                    objectId = new ObjectId(s.ToByteArray());
                    return true;
                } catch (Exception) { }
            }
        ...
        private static int GetTimestampFromDateTime(DateTime timestamp) {
            return (int)Math.Floor((timestamp.ToUniversalTime() - new DateTime(DateTime.UtcNow.ToEpoch())).TotalSeconds);
        }
