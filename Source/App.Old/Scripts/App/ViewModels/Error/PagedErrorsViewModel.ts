...
module exceptionless.error {
    export class PagedErrorsViewModel extends PagedReportViewModelBase<models.Error> {
        constructor(elementId: string, url: string, action: string, projectListViewModel: ProjectListViewModel, filterViewModel: FilterViewModel, pageSize?: number, autoUpdate?: boolean, data?: KnockoutObservableArray<models.Error>) {
