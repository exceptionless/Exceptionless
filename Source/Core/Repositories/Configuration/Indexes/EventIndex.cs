...
namespace Exceptionless.Core.Repositories.Configuration {
    ...
    public class EventIndexType : IndexType<PersistentEvent> {
        public EventIndexType(EventIndex index) : base(index, "event") { }
                ...
                .Properties(p => p
                    ...
                    .Object<DataDictionary>(f => f.Name(e => e.Data).Path("just_name").Properties(p2 => p2
                        ...
                        .String(f2 => f2.Name(Event.KnownDataKeys.SubmissionMethod).IndexName("submission").Index(FieldIndexOption.Analyzed))
                            ...
                            .String(f3 => f3.Name(r => r.Country).IndexName(Fields.LocationLevel1).Index(FieldIndexOption.NotAnalyzed))
                            .String(f3 => f3.Name(r => r.Country).IndexName(Fields.LocationLevel2).Index(FieldIndexOption.NotAnalyzed))
                            .String(f3 => f3.Name(r => r.Country).IndexName(Fields.LocationLocality).Index(FieldIndexOption.NotAnalyzed))))
                        .Object<RequestInfo>(f2 => f2.Name(Event.KnownDataKeys.RequestInfo).Path("just_name").Properties(p3 => p3
                            .String(f3 => f3.Name(r => r.ClientIpAddress).IndexName(Fields.IpAddress).Index(FieldIndexOption.Analyzed).IncludeInAll().Analyzer("comma_whitespace"))
                        ...
                        .Object<EnvironmentInfo>(f2 => f2.Name(Event.KnownDataKeys.EnvironmentInfo).Path("just_name").Properties(p3 => p3
                            .String(f3 => f3.Name(r => r.IpAddress).IndexName(Fields.IpAddress).Index(FieldIndexOption.Analyzed).IncludeInAll().Analyzer("comma_whitespace"))
                        ...
                        .Object<UserDescription>(f2 => f2.Name(Event.KnownDataKeys.UserDescription).Path("just_name").Properties(p3 => p3
                            ...
                            .String(f3 => f3.Name(r => r.EmailAddress).IndexName(Fields.UserEmail).Index(FieldIndexOption.Analyzed).IndexAnalyzer("email").SearchAnalyzer("simple").IncludeInAll().Boost(1.1))))
                        .Object<UserInfo>(f2 => f2.Name(Event.KnownDataKeys.UserInfo).Path("just_name").Properties(p3 => p3
                            .String(f3 => f3.Name(r => r.Identity).IndexName(Fields.User).Index(FieldIndexOption.Analyzed).IndexAnalyzer("email").SearchAnalyzer("whitespace_lower").IncludeInAll().Boost(1.1)
