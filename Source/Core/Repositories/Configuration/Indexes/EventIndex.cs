...
namespace Exceptionless.Core.Repositories.Configuration {
    public class EventIndex : ElasticSearchIndexBase<PersistentEvent>, ITemplatedElasticSeachIndex {
        ...
        public PutTemplateDescriptor CreateTemplate(PutTemplateDescriptor template) {
            return template
                ...
                .AddMapping<PersistentEvent>(CreateMapping);
        }

        protected override PutMappingDescriptor<PersistentEvent> CreateMapping(PutMappingDescriptor<PersistentEvent> map) {
