...
namespace Exceptionless.Core {
    public class ErrorStackRepository : MongoRepositoryOwnedByOrganization<ErrorStack>, IErrorStackRepository {
        ...
        protected override void InitializeCollection(MongoCollection<ErrorStack> collection) {
            ...
            collection.CreateIndex(M.IndexKeys.Descending(FieldNames.LastOccurrence), M.IndexOptions.SetBackground(true));
            collection.CreateIndex(M.IndexKeys.Descending(FieldNames.IsHidden, FieldNames.DateFixed), M.IndexOptions.SetBackground(true));
        }
