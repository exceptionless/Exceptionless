...
task BuildServer -depends Init {			
    ...
    TeamCity-ReportBuildStart "Downloading MaxMind database" 
	
	$MaxMindDBPath = "$source_dir\Api.IIS\App_Data" 
    ...
    TeamCity-ReportBuildStart "Finished downloading MaxMind database" 
}
