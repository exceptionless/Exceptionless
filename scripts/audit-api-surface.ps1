...
.EXAMPLE
    ...
    ./scripts/audit-api-surface.ps1

    # Run with explicit branch name and run ID
    ./scripts/audit-api-surface.ps1 -BranchName "main" -AuditRunId "live-2026-05-20"

    # Run against a different server
    ./scripts/audit-api-surface.ps1 -BaseUrl "http://localhost:5200" -EsUrl "http://localhost:9201"
#>
param(
