...
* Logs: [ASP.NET Core](https://github.com/open-telemetry/opentelemetry-dotnet/blob/core-1.15.3/src/OpenTelemetry.Exporter.Console/../../docs/logs/getting-started-aspnetcore/README.md) |
  [Console](https://github.com/open-telemetry/opentelemetry-dotnet/blob/core-1.15.3/src/OpenTelemetry.Exporter.Console/../../docs/logs/getting-started-console/README.md)
* Metrics: [ASP.NET
  Core](https://github.com/open-telemetry/opentelemetry-dotnet/blob/core-1.15.3/src/OpenTelemetry.Exporter.Console/../../docs/metrics/getting-started-aspnetcore/README.md) |
  [Console](https://github.com/open-telemetry/opentelemetry-dotnet/blob/core-1.15.3/src/OpenTelemetry.Exporter.Console/../../docs/metrics/getting-started-console/README.md)
* Traces: [ASP.NET Core](https://github.com/open-telemetry/opentelemetry-dotnet/blob/core-1.15.3/src/OpenTelemetry.Exporter.Console/../../docs/trace/getting-started-aspnetcore/README.md)
  | [Console](https://github.com/open-telemetry/opentelemetry-dotnet/blob/core-1.15.3/src/OpenTelemetry.Exporter.Console/../../docs/trace/getting-started-console/README.md)

## Configuration

See the
[`TestConsoleExporter.cs`](https://github.com/open-telemetry/opentelemetry-dotnet/blob/core-1.15.3/src/OpenTelemetry.Exporter.Console/../../examples/Console/TestConsoleExporter.cs) for
...
See [`TestMetrics.cs`](https://github.com/open-telemetry/opentelemetry-dotnet/blob/core-1.15.3/src/OpenTelemetry.Exporter.Console/../../examples/Console/TestMetrics.cs) for a runnable
example.
