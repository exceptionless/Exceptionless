...
public class UserSerializerTests : TestWithServices
{
    ...
    public void Deserialize_User_PreservesProductTourProgress()
    {
        ...
        Assert.Equal(2, deserialized.ProductTours["new-ui-overview"].Version);
        Assert.Equal(ProductTourStatus.Completed, deserialized.ProductTours["new-ui-overview"].Status);
    }
