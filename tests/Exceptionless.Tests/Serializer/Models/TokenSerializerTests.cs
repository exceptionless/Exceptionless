...
public class TokenSerializerTests : TestWithServices
{
    ...
    public void RoundTrip_WithAccessToken_PreservesValues()
    {
        ...
        Assert.Equal("t_access_abc123", result.Id);
    ...
    public void Deserialize_SnakeCaseJson_ParsesCorrectly()
    {
        // Arrange
        /* language=json */
        const string json = """{"id":"t_snake_456","organization_id":"550000000000000000000001","project_id":"540000000000000000000001","type":1,"scopes":["client","user"],"notes":"Test token","is_disabled":false,"created_by":"user1","created_utc":"2024-03-15T10:00:00Z","updated_utc":"2024-03-15T10:00:00Z"}""";
        ...
        // Assert
        Assert.NotNull(result);
        Assert.Equal("t_snake_456", result.Id);
        Assert.Equal("550000000000000000000001", result.OrganizationId);
        Assert.Equal(TokenType.Access, result.Type);
