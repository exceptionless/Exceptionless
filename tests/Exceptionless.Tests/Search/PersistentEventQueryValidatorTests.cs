...
public sealed class PersistentEventQueryValidatorTests : TestWithServices
{
    ...
    [InlineData("environment:production", "environment:production", true, false)]
    [InlineData("environment:(production OR staging)", "environment:(production OR staging)", true, false)]
    [InlineData("_missing_:environment", "_missing_:environment", true, false)]
    ...
    [InlineData("terms:(environment~100)", true, false)]
    [InlineData("cardinality:environment", true, false)]
