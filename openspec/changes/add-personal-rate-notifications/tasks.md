...
- [x] **Add compiled RateNotificationRuleCache service**
  ...
  - Coordinate shared-cache fills and invalidation across replicas on rule-management changes and lifecycle cleanup without churning the plan for evaluator bookkeeping
