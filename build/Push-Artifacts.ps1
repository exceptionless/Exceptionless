...
ROBOCOPY "$sourceDir\Jobs\CleanupSnapshot\bin\Release\netcoreapp2.0" "$artifactsDir\jobs\triggered\CleanupSnapshot" /XD "$sourceDir\Jobs\CleanupSnapshot\bin\Release\netcoreapp2.0\publish" /S /NFL /NDL /NJH /NJS /nc /ns /np /XF "appsettings.Development.yml" "Exceptionless.*" "System.*"
Write-Host "Copying CloseInactiveSession job..."
ROBOCOPY "$sourceDir\Jobs\CloseInactiveSession\bin\Release\netcoreapp2.0" "$artifactsDir\jobs\continuous\CloseInactiveSession" /XD "$sourceDir\Jobs\CloseInactiveSession\bin\Release\netcoreapp2.0\publish" /S /NFL /NDL /NJH /NJS /nc /ns /np /XF "appsettings.Development.yml" "Exceptionless.*" "System.*"
Write-Host "Copying DailySummary job..."
ROBOCOPY "$sourceDir\Jobs\DailySummary\bin\Release\netcoreapp2.0" "$artifactsDir\jobs\continuous\DailySummary" /XD "$sourceDir\Jobs\DailySummary\bin\Release\netcoreapp2.0\publish" /S /NFL /NDL /NJH /NJS /nc /ns /np /XF "appsettings.Development.yml" "Exceptionless.*" "System.*"
Write-Host "Copying DownloadGeoIPDatabase job..."
ROBOCOPY "$sourceDir\Jobs\DownloadGeoIPDatabase\bin\Release\netcoreapp2.0" "$artifactsDir\jobs\triggered\DownloadGeoIPDatabase" /XD "$sourceDir\Jobs\DownloadGeoIPDatabase\bin\Release\netcoreapp2.0\publish" /S /NFL /NDL /NJH /NJS /nc /ns /np /XF "appsettings.Development.yml" "Exceptionless.*" "System.*"
Write-Host "Copying EventNotification job..."
ROBOCOPY "$sourceDir\Jobs\EventNotification\bin\Release\netcoreapp2.0" "$artifactsDir\jobs\continuous\EventNotification" /XD "$sourceDir\Jobs\EventNotification\bin\Release\netcoreapp2.0\publish" /S /NFL /NDL /NJH /NJS /nc /ns /np /XF "appsettings.Development.yml" "Exceptionless.*" "System.*"
Write-Host "Copying EventPost job..."
ROBOCOPY "$sourceDir\Jobs\EventPost\bin\Release\netcoreapp2.0" "$artifactsDir\jobs\continuous\EventPost" /XD "$sourceDir\Jobs\EventPost\bin\Release\netcoreapp2.0\publish"  /S /NFL /NDL /NJH /NJS /nc /ns /np /XF "appsettings.Development.yml" "Exceptionless.*" "System.*"
ROBOCOPY "$sourceDir\Jobs\EventPost\bin\Release\netcoreapp2.0" "$artifactsDir\jobs\continuous\EventPost2" /XD "$sourceDir\Jobs\EventPost\bin\Release\netcoreapp2.0\publish" /S /NFL /NDL /NJH /NJS /nc /ns /np /XF "appsettings.Development.yml" "Exceptionless.*" "System.*"
ROBOCOPY "$sourceDir\Jobs\EventPost\bin\Release\netcoreapp2.0" "$artifactsDir\jobs\continuous\EventPost3" /XD "$sourceDir\Jobs\EventPost\bin\Release\netcoreapp2.0\publish" /S /NFL /NDL /NJH /NJS /nc /ns /np /XF "appsettings.Development.yml" "Exceptionless.*" "System.*"
ROBOCOPY "$sourceDir\Jobs\EventPost\bin\Release\netcoreapp2.0" "$artifactsDir\jobs\continuous\EventPost4" /XD "$sourceDir\Jobs\EventPost\bin\Release\netcoreapp2.0\publish" /S /NFL /NDL /NJH /NJS /nc /ns /np /XF "appsettings.Development.yml" "Exceptionless.*" "System.*"
Write-Host "Copying EventSnapshot job..."
ROBOCOPY "$sourceDir\Jobs\EventSnapshot\bin\Release\netcoreapp2.0" "$artifactsDir\jobs\triggered\EventSnapshot" /XD "$sourceDir\Jobs\EventSnapshot\bin\Release\netcoreapp2.0\publish" /S /NFL /NDL /NJH /NJS /nc /ns /np /XF "appsettings.Development.yml" "Exceptionless.*" "System.*"
Write-Host "Copying EventUserDescription job..."
ROBOCOPY "$sourceDir\Jobs\EventUserDescription\bin\Release\netcoreapp2.0" "$artifactsDir\jobs\continuous\EventUserDescription" /XD "$sourceDir\Jobs\EventUserDescription\bin\Release\netcoreapp2.0\publish" /S /NFL /NDL /NJH /NJS /nc /ns /np /XF "appsettings.Development.yml" "Exceptionless.*" "System.*"
Write-Host "Copying MailMessage job..."
ROBOCOPY "$sourceDir\Jobs\MailMessage\bin\Release\netcoreapp2.0" "$artifactsDir\jobs\continuous\MailMessage" /XD "$sourceDir\Jobs\MailMessage\bin\Release\netcoreapp2.0\publish" /S /NFL /NDL /NJH /NJS /nc /ns /np /XF "appsettings.Development.yml" "Exceptionless.*" "System.*"
Write-Host "Copying MaintainIndexes job..."
ROBOCOPY "$sourceDir\Jobs\MaintainIndexes\bin\Release\netcoreapp2.0" "$artifactsDir\jobs\triggered\MaintainIndexes" /XD "$sourceDir\Jobs\MaintainIndexes\bin\Release\netcoreapp2.0\publish" /S /NFL /NDL /NJH /NJS /nc /ns /np /XF "appsettings.Development.yml" "Exceptionless.*" "System.*"
Write-Host "Copying OrganizationSnapshot job..."
ROBOCOPY "$sourceDir\Jobs\OrganizationSnapshot\bin\Release\netcoreapp2.0" "$artifactsDir\jobs\triggered\OrganizationSnapshot" /XD "$sourceDir\Jobs\OrganizationSnapshot\bin\Release\netcoreapp2.0\publish" /S /NFL /NDL /NJH /NJS /nc /ns /np /XF "appsettings.Development.yml" "Exceptionless.*" "System.*"
Write-Host "Copying RetentionLimit job..."
ROBOCOPY "$sourceDir\Jobs\RetentionLimit\bin\Release\netcoreapp2.0" "$artifactsDir\jobs\continuous\RetentionLimit" /XD "$sourceDir\Jobs\RetentionLimit\bin\Release\netcoreapp2.0\publish" /S /NFL /NDL /NJH /NJS /nc /ns /np /XF "appsettings.Development.yml" "Exceptionless.*" "System.*"
Write-Host "Copying StackSnapshot job..."
ROBOCOPY "$sourceDir\Jobs\StackSnapshot\bin\Release\netcoreapp2.0" "$artifactsDir\jobs\triggered\StackSnapshot" /XD "$sourceDir\Jobs\StackSnapshot\bin\Release\netcoreapp2.0\publish" /S /NFL /NDL /NJH /NJS /nc /ns /np /XF "appsettings.Development.yml" "Exceptionless.*" "System.*"
Write-Host "Copying WebHook job..."
ROBOCOPY "$sourceDir\Jobs\WebHook\bin\Release\netcoreapp2.0" "$artifactsDir\jobs\continuous\WebHook" /XD "$sourceDir\Jobs\WebHook\bin\Release\netcoreapp2.0\publish" /S /NFL /NDL /NJH /NJS /nc /ns /np /XF "appsettings.Development.yml" "Exceptionless.*" "System.*"
Write-Host "Copying WorkItem job..."
ROBOCOPY "$sourceDir\Jobs\WorkItem\bin\Release\netcoreapp2.0" "$artifactsDir\jobs\continuous\WorkItem" /XD "$sourceDir\Jobs\WorkItem\bin\Release\netcoreapp2.0\publish" /S /NFL /NDL /NJH /NJS /nc /ns /np /XF "appsettings.Development.yml" "Exceptionless.*" "System.*"
ROBOCOPY "$sourceDir\Jobs\WorkItem\bin\Release\netcoreapp2.0" "$artifactsDir\jobs\continuous\WorkItem2" /XD "$sourceDir\Jobs\WorkItem\bin\Release\netcoreapp2.0\publish" /S /NFL /NDL /NJH /NJS /nc /ns /np /XF "appsettings.Development.yml" "Exceptionless.*" "System.*"
