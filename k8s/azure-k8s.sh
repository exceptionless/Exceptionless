...
kubectl set image deployment,cronjob -l tier=exceptionless-api *=exceptionless/api-ci:5.0.3339-pre
kubectl set image deployment,cronjob -l tier=exceptionless-job *=exceptionless/job-ci:5.0.3339-pre
